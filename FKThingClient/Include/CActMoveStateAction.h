...
//------------------------------------------------------------------------
class CCreatureActMoveState : public ICreatureActState
{	
public:
	// 创建
...
public:
	// 消息过滤函数
	typedef BOOL (CCreatureActMoveState::*FILTER_MESSAGE_PROC)(LPCSTR buf, int nLen);
